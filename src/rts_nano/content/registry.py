...
BUILDING_DEFINITIONS = (
    ...
    BuildingDefinition(
        ...
        max_life=500,
        vision_range=400,
        produces=(ContentId("marksman"), ContentId("guardian")),
    ),
    BuildingDefinition(
        id=ContentId("spire"),
        display_name="Spire",
    ...
    BuildingDefinition(
        ...
        max_life=500,
        vision_range=400,
        produces=(ContentId("ripper"), ContentId("spitter")),
    ),
    BuildingDefinition(
...
FACTION_DEFINITIONS = (
    FactionDefinition(
        id=FactionId("AEGIS"),
        display_name="AEGIS",
        unit_ids=(ContentId("peasant"), ContentId("marksman"), ContentId("guardian"), ContentId("arclight")),
        building_ids=(
            ContentId("base"),
            ContentId("house"),
            ContentId("arsenal"),
    ...
    FactionDefinition(
        id=FactionId("RUST"),
        display_name="RUST",
        unit_ids=(ContentId("peasant"), ContentId("ripper"), ContentId("spitter"), ContentId("brute")),
        building_ids=(
            ContentId("base"),
            ContentId("house"),
            ContentId("pit"),
