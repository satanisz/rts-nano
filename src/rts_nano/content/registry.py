...
ABILITY_DEFINITIONS: tuple[AbilityDefinition, ...] = (
    AbilityDefinition(
        id=AbilityId("barrier_pulse"),
        display_name="Barrier Pulse",
        description="Restore shields to up to six nearby allied units and buildings.",
        target_kind=AbilityTargetKind.AREA,
        effect_kind=AbilityEffectKind.BARRIER_PULSE,
        energy_cost=40,
        cooldown_frames=180,
        cast_range=180,
        radius=170,
    ...
    AbilityDefinition(
        id=AbilityId("arc_bind"),
        display_name="Arc Bind",
        description="Mark and slow one enemy for a bounded duration.",
        target_kind=AbilityTargetKind.ENEMY,
        effect_kind=AbilityEffectKind.ARC_BIND,
        energy_cost=35,
        cooldown_frames=150,
        cast_range=230,
        duration_frames=120,
    ...
    AbilityDefinition(
        id=AbilityId("toxic_cloud"),
        display_name="Toxic Cloud",
        description="Poison up to eight enemies in a bounded ground area.",
        target_kind=AbilityTargetKind.AREA,
        effect_kind=AbilityEffectKind.TOXIC_CLOUD,
        energy_cost=40,
        cooldown_frames=180,
        cast_range=220,
        duration_frames=120,
    ...
    AbilityDefinition(
        id=AbilityId("mutagenic_surge"),
        display_name="Mutagenic Surge",
        description="Temporarily accelerate up to six nearby allied melee units.",
        target_kind=AbilityTargetKind.AREA,
        effect_kind=AbilityEffectKind.MUTAGENIC_SURGE,
        energy_cost=45,
        cooldown_frames=180,
        cast_range=190,
        duration_frames=120,
...
UPGRADE_DEFINITIONS: tuple[UpgradeDefinition, ...] = (
    UpgradeDefinition(
        id=UpgradeId("aegis_knight_bulwark"),
        display_name="Bulwark Doctrine",
        description="Knights gain shields and additional protection while holding position.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("arsenal"),),
        cost=ResourceCost(wood=120, gold=80),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("aegis_knight_doctrine"),
        affected_content=(ContentId("knight"),),
        modifiers=(
            StatModifier(ModifierStat.SHIELD_MAX, add=40),
            StatModifier(ModifierStat.SHIELD_REGEN, add=4),
        ),
        granted_behaviors=("bulwark_hold",),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_knight_vanguard"),
        display_name="Vanguard Doctrine",
        description="Knights build charge through movement and impact their first melee target.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("arsenal"),),
        cost=ResourceCost(wood=100, gold=100),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("aegis_knight_doctrine"),
        affected_content=(ContentId("knight"),),
        modifiers=(StatModifier(ModifierStat.SPEED, numerator=11, denominator=10),),
        granted_behaviors=("vanguard_charge",),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_archer_longshot"),
        display_name="Longshot Doctrine",
        description="Archers gain reach but retain a larger dead zone and slower firing setup.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("arsenal"),),
        cost=ResourceCost(wood=110, gold=90),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("aegis_archer_doctrine"),
        affected_content=(ContentId("archer"),),
        modifiers=(
            StatModifier(ModifierStat.RANGED_ATTACK_RANGE, add=60),
            StatModifier(ModifierStat.RANGED_MIN_ATTACK_RANGE, add=20),
            StatModifier(ModifierStat.ATTACK_SPEED, numerator=6, denominator=5),
        ),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_archer_arcshot"),
        display_name="Arcshot Doctrine",
        description="Ranged hits mark enemies for AEGIS combined-arms focus fire.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("arsenal"),),
        cost=ResourceCost(wood=90, gold=110),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("aegis_archer_doctrine"),
        affected_content=(ContentId("archer"),),
        granted_behaviors=("arcshot_mark",),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_mage_shieldweaver"),
        display_name="Shieldweaver Doctrine",
        description="Mages gain a shield and unlock Barrier Pulse formation support.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("spire"),),
        cost=ResourceCost(wood=100, gold=140),
        research_frames=300,
        exclusive_group=ExclusivityGroupId("aegis_mage_doctrine"),
        affected_content=(ContentId("mage"),),
        modifiers=(StatModifier(ModifierStat.SHIELD_MAX, add=30),),
        granted_abilities=(AbilityId("barrier_pulse"),),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_mage_arcbinder"),
        display_name="Arcbinder Doctrine",
        description="Mages unlock Arc Bind for precision control and target marking.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("spire"),),
        cost=ResourceCost(wood=90, gold=150),
        research_frames=300,
        exclusive_group=ExclusivityGroupId("aegis_mage_doctrine"),
        affected_content=(ContentId("mage"),),
        granted_abilities=(AbilityId("arc_bind"),),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_shield_network"),
        display_name="Shield Network",
        description="Strengthen shield capacity across the AEGIS combined-arms line.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("spire"),),
        cost=ResourceCost(wood=140, gold=160),
        research_frames=360,
        required_upgrades=(UpgradeId("aegis_mage_shieldweaver"),),
        affected_content=(
            ContentId("knight"),
            ContentId("mage"),
            ContentId("marksman"),
        ...
        modifiers=(StatModifier(ModifierStat.SHIELD_MAX, add=15),),
    ),
    UpgradeDefinition(
        id=UpgradeId("aegis_arc_targeting"),
        display_name="Arc Targeting",
        description="Arclight deals a stronger bounded bonus against arc-marked targets.",
        faction=FactionId("AEGIS"),
        research_at=(ContentId("spire"),),
        cost=ResourceCost(wood=130, gold=170),
        research_frames=360,
        required_upgrades=(UpgradeId("aegis_archer_arcshot"),),
        affected_content=(ContentId("arclight"),),
        granted_behaviors=("arc_targeting",),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_knight_frenzy"),
        display_name="Frenzy Doctrine",
        description="Wounded Knights attack faster through the bounded frenzy model.",
        faction=FactionId("RUST"),
        research_at=(ContentId("pit"),),
        cost=ResourceCost(wood=100, gold=100),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("rust_knight_doctrine"),
        affected_content=(ContentId("knight"),),
        granted_behaviors=("rust_frenzy",),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_knight_pack"),
        display_name="Pack Doctrine",
        description="Knights gain bounded damage from nearby allied melee units.",
        faction=FactionId("RUST"),
        research_at=(ContentId("pit"),),
        cost=ResourceCost(wood=110, gold=90),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("rust_knight_doctrine"),
        affected_content=(ContentId("knight"),),
        granted_behaviors=("rust_pack",),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_archer_venom"),
        display_name="Venom Doctrine",
        description="Archer hits apply a refreshing bounded poison.",
        faction=FactionId("RUST"),
        research_at=(ContentId("pit"),),
        cost=ResourceCost(wood=90, gold=110),
        research_frames=240,
        exclusive_group=ExclusivityGroupId("rust_archer_doctrine"),
        affected_content=(ContentId("archer"),),
        modifiers=(
            StatModifier(ModifierStat.POISON_DAMAGE, add=2),
            StatModifier(ModifierStat.POISON_DURATION, add=90),
        ),
        granted_behaviors=("rust_venom",),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_archer_skirmisher"),
        display_name="Skirmisher Doctrine",
        description="Archers reposition faster, fire sooner, and have a smaller dead zone.",
        faction=FactionId("RUST"),
        research_at=(ContentId("pit"),),
        cost=ResourceCost(wood=110, gold=90),
        research_frames=240,
        ...
        affected_content=(ContentId("archer"),),
        modifiers=(
            StatModifier(ModifierStat.SPEED, numerator=6, denominator=5),
            StatModifier(ModifierStat.ATTACK_SPEED, numerator=9, denominator=10),
            StatModifier(ModifierStat.RANGED_MIN_ATTACK_RANGE, add=-15),
        ),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_mage_plaguecaller"),
        display_name="Plaguecaller Doctrine",
        description="Mages unlock Toxic Cloud for bounded area attrition.",
        faction=FactionId("RUST"),
        research_at=(ContentId("chem_vat"),),
        cost=ResourceCost(wood=100, gold=140),
        research_frames=300,
        exclusive_group=ExclusivityGroupId("rust_mage_doctrine"),
        affected_content=(ContentId("mage"),),
        granted_abilities=(AbilityId("toxic_cloud"),),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_mage_mutagenist"),
        display_name="Mutagenist Doctrine",
        description="Mages unlock Mutagenic Surge for a capped allied swarm timing window.",
        faction=FactionId("RUST"),
        research_at=(ContentId("chem_vat"),),
        cost=ResourceCost(wood=90, gold=150),
        research_frames=300,
        exclusive_group=ExclusivityGroupId("rust_mage_doctrine"),
        affected_content=(ContentId("mage"),),
        granted_abilities=(AbilityId("mutagenic_surge"),),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_advanced_mutations"),
        display_name="Advanced Mutations",
        description="Strengthen the bounded Pack interaction for RUST Knights.",
        faction=FactionId("RUST"),
        research_at=(ContentId("chem_vat"),),
        cost=ResourceCost(wood=140, gold=160),
        research_frames=360,
        required_upgrades=(UpgradeId("rust_knight_pack"),),
        affected_content=(ContentId("knight"),),
        granted_behaviors=("advanced_mutations",),
    ),
    UpgradeDefinition(
        id=UpgradeId("rust_concentrated_toxins"),
        display_name="Concentrated Toxins",
        description="Increase Archer poison strength and duration.",
        faction=FactionId("RUST"),
        research_at=(ContentId("chem_vat"),),
        cost=ResourceCost(wood=130, gold=170),
        research_frames=360,
        required_upgrades=(UpgradeId("rust_archer_venom"),),
        affected_content=(ContentId("archer"),),
        modifiers=(
            StatModifier(ModifierStat.POISON_DAMAGE, add=1),
            StatModifier(ModifierStat.POISON_DURATION, add=30),
        ),
    ),
)
